...
namespace FM.Infrastructure.Seeds
{
    public class SeedData
    {
        ...
        public static async Task SeedDefaultToken(List<FbToken> listFbTokens, ApplicationDbContext appContext)
        {
            var listToken = ExcelUtil.MakeListFbTokensFromExcelFile("FbTokens.xlsx");
